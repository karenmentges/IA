...
def extrair_propriedades(caminho_imagem, imagem):
    ...
    tamanho_do_arquivo_em_bytes = os.path.getsize(caminho_imagem)                       # Obter tamanho da imagem
    tamanho_do_arquivo_em_kb = tamanho_do_arquivo_em_bytes/1024 
    ...
    return {
        "altura": altura,
        "largura": largura,
        "tamanho_do_arquivo (KB)": tamanho_do_arquivo_em_kb,
...
def aplicar_k_means(imagem, k):
    ...
    kmeans = KMeans(n_clusters=k, n_init=10)                                            # Aplicar o algoritmo k-médias
...
def plotar_imagens(imagem_segmentada):
    ...
    plt.savefig('image1_3Colors.png', dpi=500, bbox_inches='tight', pad_inches=0.0)     # Exportar a imagem
...
def main():
    ...
    caminho_imagem_segmentada = "image1_3Colors.png"                                                # Definir caminho da imagem segmentada
